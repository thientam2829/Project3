...
(1342, 'MAI', 'mai', 'https://www.youtube.com/watch?v=HXWRTGbhb4U', 'http://res.cloudinary.com/thientam2829/image/upload/v1705972188/qrihc8knbqj8lxysqvxa.jpg', '\"Mai\" xoay quanh cuộc đời của một người phụ nữ đẹp tên Mai (do Phương Anh Đào thủ vai) có số phận rất đặc biệt. Bởi làm nghề mát xa, Mai thường phải đối mặt với ánh nhìn soi mói, phán xét từ những người xung quanh.', 'Trấn Thành', 'Phương Anh Đào, Tuấn Trần, Trấn Thành, Uyển Ân, Hồng Đào, NSND Việt Anh, NSND Ngọc Giàu, ...', 'Việt Nam', 'Tâm lý-tình cảm', '2D', 'GP09', '31/01/2024', 5),
...
(1, '[Review] Migration: Nhà Vịt Có Đủ Sức Thành Hiện Tượng Như Minions?', 'Từ ngày Minions trở thành hiện tượng toàn cầu, độ nổi tiếng của studio Illumination cũng tăng theo cấp số nhân.\\n Ngoài việc chú trọng vào phát triển các phim hoạt hình liên quan đến những quả chuối biết đi như Despicable Me và Minions, Illumination mạnh tay đầu tư cho các phim hoạt hình khác. Họ không ngại thử sức đề tài mới như The Secret Life Of Pets, The Grinch và Sing. Tất cả đều đạt thành công lớn. Đẳng Cấp Thú Cưng và Đấu Trường Âm Nhạc đều ra mắt phần mới và tiếp tục được khán giả toàn cầu ủng hộ. Lần này, Illumination tiếp tục đưa khán giả khám phá cuộc sống của các động vật hoang dã trong Migration. Ở vùng ao yên bình nọ thuộc vùng New England, ngày qua ngày, gia đình vịt cổ xanh Mack sống vui vẻ bên nhau. Vịt bố Mack luôn chú trọng dạy các con tránh xa nguy hiểm, rằng chim diệc là kẻ săn mồi nguy hiểm, ngoài nơi chúng sống thì không nên đi đâu cả.Tuy nhiên, vào buổi nọ, lời răn đe mang tính lí thuyết của Mack trở nên lung lay khi đàn vịt di trú bay ngang qua. Câu chuyện kể về vùng đất Jamaica xa xôi, ấm áp với dòng nước phát sáng khiến vịt mẹ Pam và hai vịt con Dax – Gwen khao khát đi xa. Dĩ nhiên, vì bản tính thích an toàn, Mack làm sao đồng ý nổi. Sau một hồi tranh cãi, rốt cuộc, vịt bố phải chịu thua ba mẹ con. Cả nhà Mack cùng người chú Dan quyết định tới Jamaica mở mang tầm mắt! Chuyến phiêu lưu khởi đầu rất thuận lợi. Thế nhưng, do lần đầu ra khỏi nơi cư trú, nhà vịt đã bay nhầm đường. Thay vì đến Jamaica, chúng bay nhầm vào… thành phố New York! Sau Sing (2016), Migration là tác phẩm gốc đầu tiên của Illumination, không phải hậu truyện hoặc chuyển thể. Nhờ kinh nghiệm dày dặn từ The Secret Life Of Pets và Sing, chẳng quá khó khăn cho ekip Illumination thực hiện bộ phim thứ 14 với nhân vật chính là động vật. Những chú vịt thân thiện, hiền lành, “nhà quê” (theo lời bồ câu Chump). Mỗi thành viên nhà Mack có điểm mạnh lẫn điểm yếu, điểm tốt và chưa tốt dần hiện ra trên chuyến hành trình. Mâu thuẫn âm ỉ trong gia đình cũng bùng lên thông qua biến cố. Tuy nhiên, nhà vịt luôn yêu thương nhau và cùng vượt qua hoạn nạn. Migration khai thác đề tài “nhà vịt di cư” nghe qua khá mới lạ nhưng tựu trung vẫn là bình mới rượu cũ. Gia đình đoàn kết vượt qua khó khăn và đối diện với nỗi sợ bản thân để khám phá khía cạnh mới trong cuộc sống đều là hai đề tài quen thuộc của bộ môn nghệ thuật thứ 7. Dẫu vậy, phim ghi điểm bởi lối kể chuyện gãy gọn, súc tích. Các tình huống giải quyết nhanh gọn. Từ trẻ em đến người lớn, ai cũng dễ dàng hiểu được và cảm được. Đạo diễn kiêm biên kịch phim Benjamin Renner mô tả Migration như phim kinh điển Little Miss Sunshine phiên bản vịt. Dĩ nhiên, mọi mâu thuẫn rắc rối đều giảm nhẹ hết cỡ. Phim tương tự The Secret Life Of Pets, cách giải quyết vấn đề theo hướng “logic phim hoạt hình” – chẳng theo logic nào cả. Người xem sẽ có dịp cười lăn cười bò, cười rung cả ghế rạp chiếu phim bởi hàng tá bất ngờ mà Migration mang lại. Những quy luật tự nhiên gần như vô nghĩa, hệt như cách Minions phụng sự cho Napoleon hay lên làm lãnh đạo Anh quốc nhờ rút được thanh gươm báu.   Chính vì vậy, so với Sing, Migration ít tình huống cảm động rơi nước mắt. Các nhân vật hài hước, đơn giản và “vô tri”. Mâu thuẫn gia đình, vợ chồng, cha mẹ - con gái hay sự bướng bỉnh tuổi dậy thì trôi tuột trên màn ảnh, những tình tiết hài hước ấn tượng hơn. Ngược lại, đồ họa của Migration thật sự là thử thách với ekip làm phim. Thiết kế sản xuất Colin Stimpson mô tả: “Vịt là sinh vật kì lạ, cực kì phức tạp và bề ngoài rất giống nhau.” Benjamin Renner kể rằng anh cùng năm chục họa sĩ hãng Illumination đã dày công nghiên cứu loài vịt để thực hiện dự án. Cuối cùng, ekip cũng tạo ra gia đình Mack – Pam – Dax – Gwen và Dan mỗi vịt một vẻ. Dễ thương, gần gũi, ấn tượng và không lẫn vào đâu được. Tuy nhiên, hiệu ứng trung bình Nhà Vịt Di Cư đem lại phần nào cho thấy tình trạng đáng báo động ở Illumination. Họ đang quá phụ thuộc vào Minions. Ngoài những quả chuối biết đi, hãng chẳng có mấy nhân vật đủ làm công chúng nhớ năm này qua năm nọ. Đây là điều hãng cần khắc phục trong tương lai để sự nổi tiếng của Minions bớt lấn át các phim mới khác. Từ nội dung đến chất lượng đồ họa đều đủ sức hấp dẫn khán giả, Migration là tựa phim tuyệt vời, đáng cho cả gia đình cùng dành thời gian ra rạp đầu năm.\r\n', '2024-01-23 04:22:24');
...
--
ALTER TABLE `cumrapvalichchieuinsert`
  MODIFY `clid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
...
--
ALTER TABLE `lichchieuinsert`
  MODIFY `maLichChieu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16558;
...
--
ALTER TABLE `phiminsertvalichchieuinsert`
  MODIFY `plid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
