...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 01, 2024 at 07:45 AM
...
INSERT INTO `chi_tiet_phim` (`maPhim`, `tenPhim`, `biDanh`, `trailer`, `hinhAnh`, `moTa`, `daoDien`, `dienVien`, `quocGia`, `theLoai`, `dinhDang`, `maNhom`, `ngayKhoiChieu`, `danhGia`) VALUES
...
(1337, 'Đào, Phở và Piano', 'dao-pho-va-piano', 'https://www.youtube.com/watch?v=qn1t_biQigc&t=12s', 'https://res.cloudinary.com/thientam2829/image/upload/v1708938878/aw07r0fkhvduakqhvf7u.webp', 'Lấy bối cảnh trận chiến đông xuân kéo dài 60 ngày đêm từ cuối năm 1946 đến đầu năm 1947 ở Hà Nội, câu chuyện theo chân chàng dân quân Văn Dân và chuyện tình với nàng tiểu thư đam mê dương cầm Thục Hương. Khi những người khác đã di tản lên chiến khu, họ quyết định cố thủ lại mảnh đất thủ đô đã tan hoang vì bom đạn, mặc cho những hiểm nguy đang chờ đợi trước mắt', 'Phi Tiến Sơn', 'NSƯT Trần Lực, NSND Trung Hiếu, Doãn Quốc Đam, Tuấn Hưng, Nguyệt Hằng, Anh Tuấn,..', 'Việt Nam', 'Lịch Sử, Tình Cảm', '2D', 'GP09', '27/2/2024', 10),
(1342, 'Quỷ Cẩu', 'quỷ-cẩu', 'https://www.youtube.com/watch?v=cYCOcxWgPVU', 'http://res.cloudinary.com/thientam2829/image/upload/v1706346799/q0gjmhqqynjwcjevc2kk.jpg', 'Nam về quê để lo đám tang cho bố sau cái chết kinh hoàng của ông, trong khi phải che giấu bạn gái đang mang thai. Nam mơ thấy gia đình bị giết sau khi mai táng bố, và Mít – con chó trắng của gia đình có biểu hiện kì lạ. Ông Quyết, bà Thúy, và bà Liễu thì tin vào thầy cúng, còn Nam nghi ngờ về lò mổ chó truyền thống của gia đình và phải điều tra để giải quyết sự kiện kỳ lạ đang diễn ra.', 'Lưu Thành Luân', ' Quang Tuấn, NSND Kim Xuân, Vân Dung, Quốc Quân, Nam Thư, Mie….', 'Việt Nam', 'Kinh Dị', '2D', 'GP09', '26/02/2024', 5),
...
(195, '95', 'Vip', 150000, 'thientam', 16546);
...
INSERT INTO `nguoi_dung` (`id`, `taiKhoan`, `matKhau`, `email`, `soDt`, `maNhom`, `maLoaiNguoiDung`, `hoTen`, `otp`, `daXacThuc`, `otpCreatedAt`, `resetPasswordToken`) VALUES
(1, 'admin', '1234567', 'cosmocinemaldh@gmail.com', '0343344658', 'GP09', 'QuanTri', 'Admin', NULL, 1, NULL, NULL),
(26, 'admin', 'e10adc3949ba59abbe56e057f20f883e', 'admin@gmail.com', '099356765', 'GP09', 'QuanTri', 'ADMIN', NULL, 1, NULL, NULL),
(47, 'thientam', 'e10adc3949ba59abbe56e057f20f883e', 'thientam2829@gmail.com', '0763344621', 'GP09', 'KhachHang', 'Nguyen Thien Tam', NULL, 1, NULL, ''),
(48, 'thientam', 'e10adc3949ba59abbe56e057f20f883e', 'tamnt.124010121035@vtc.edu.vn', '0763344621', 'GP09', 'KhachHang', 'Nguyen Thien Tam', NULL, 1, NULL, NULL);
...
--
ALTER TABLE `datve`
  MODIFY `maGhe` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=196;
