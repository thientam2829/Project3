...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 30, 2024 at 01:14 PM
...
(215, '89', 'Vip', 140000, 'admin', '2024-03-26 09:06:21', 16566),
(216, '90', 'Vip', 120000, 'admin', '2024-03-26 09:06:21', 16566),
(217, '91', 'Vip', 120000, 'admin', '2024-03-26 09:06:21', 16566);
...
(16565, '25/03/2024 13:41:00', 451, 'Rạp 1', 120000, 120),
(16566, '27/03/2024 20:39:00', 453, 'Rạp 3', 120000, 120);
...
--
ALTER TABLE `chi_tiet_phim`
  MODIFY `maPhim` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1705;
...
--
ALTER TABLE `cumrap_va_lichchieu`
  MODIFY `clid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
...
--
ALTER TABLE `datve`
  MODIFY `maGhe` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=218;
...
--
ALTER TABLE `hethongrapvaphim`
  MODIFY `hpid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;

--
-- AUTO_INCREMENT for table `lichchieuinsert`
--
ALTER TABLE `lichchieuinsert`
  MODIFY `maLichChieu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16568;

--
-- AUTO_INCREMENT for table `lich_chieu`
--
ALTER TABLE `lich_chieu`
  MODIFY `plid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
